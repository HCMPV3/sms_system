    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="widget widget-stats bg-green">
                ...
                <div class="stats-desc">There are 200 users recieving sms/emails</div>
            </div>
        </div>
        <!-- end col-3 -->
        <!-- begin col-3 -->
        <div class="col-md-4 col-sm-6">
            <div class="widget widget-stats bg-blue">
                ...
                <div class="stats-desc">There are 150 people recieving email messages</div>
            </div>
        </div>
        <!-- end col-3 -->
        <div class="col-md-4 col-sm-6">
            <div class="widget widget-stats bg-purple">
                ...
                <div class="stats-desc">There are 200 people recieving sms messages</div>
            </div>
        </div>
        <!--
